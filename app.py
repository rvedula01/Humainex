...
def main():
    ...
    st.title("📝 TEAMS Post-Call Whiteboard Generator")
    ...
    <div class="description-container">
        <p class="description-text">
            Hi there! This AI application is your fingertips to transform incident meeting transcripts into smart, actionable summaries in record time.
        </p>
        <p class="description-text">
